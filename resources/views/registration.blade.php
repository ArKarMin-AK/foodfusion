...
<head>
    ...
    <title>Food Fusion Registration</title>
...
<body>
    <form class="register-form ms-auto bg-secondary-subtle me-auto p-3 m-3 border border-3 rounded-3"  action="{{route('register_post')}}" method="POST" style="width: 500px">
        @csrf
        <!-- Heading -->
        <div class="text-center fs-1 text-white">Welcome to FoodFusion</div>
        <!-- First Name Input -->
        <div class="mb-3">
            <label for="UserFirstName" class="form-label text-white">First Name</label>
            <input type="text" class="form-control" name="First_Name" id="UserFirstName" placeholder="Enter your First Name">
            <p class="error text-danger">{{$errors->first('First_Name')}}</p>
        </div>
        <!-- Last Name Input -->
        <div class="mb-3">
            <label for="UserLastName" class="form-label text-white">Last Name</label>
            <input type="text" class="form-control" name="Last_Name" id="UserLastName" placeholder="Enter your Last Name">
            <p class="error text-danger">{{$errors->first('Last_Name')}}</p>
        </div>
        <!-- Email Input -->
        <div class="mb-3">
            <label for="UserEmail" class="form-label text-white">Email</label>
            <input type="email" class="form-control" name="email" id="UserEmail" aria-describedby="emailHelp" placeholder="Enter your email">        
            <p class="error text-danger">{{$errors->first('email')}}</p>
        </div>
        <!-- Password Input -->
        <div class="mb-3">
            <label for="UserRPassword" class="form-label text-white">Password</label>
            <input type="password" placeholder="At least 8 characters" class="form-control" name="password" id="UserRPassword">
        ...
        <div class="mb-3">
            ...
            <input type="password" placeholder="At least 8 characters" class="form-control" name="password_confirmation" id="confirmRpassword">
        ...
        <div class="mb-3 form-check mt-2 mb-2">
            <input type="checkbox"  class="form-check-input " >
            <label class="form-check-label text-white" required>I agree to the terms and privacy policy of FoodFusion</label>
        </div>
        <div class="mb-2 mt-2 text-center form-check text-white">
