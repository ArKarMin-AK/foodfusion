...
@if (session()->has('status'))
        ...
        @endif
<form class="reset-form ms-auto bg-secondary-subtle mt-4 mb-3 me-auto justify-content-center p-3 border border-3 rounded-3" action="{{route('password.email')}}" method="POST" style="width:400px">
        @csrf
        <!-- Heading -->
        <div class="text-center fst-italic fs-1 justify-content-center text-white"  >Enter Email to Reset Password</div>
        <!-- Email Input -->
        <div class="mb-3 mt-3">
        ...
        <!-- Submit Button -->
        <button type="submit" id="loginbtn" class="btn btn-primary bg-white text-dark border-dark m-3">RESET</button>
